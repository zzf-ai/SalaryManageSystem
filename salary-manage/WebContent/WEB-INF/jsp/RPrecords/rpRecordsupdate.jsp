...
<body>
	<form
		action="${pageContext.request.contextPath }/RPrecordsupdate.action"
		...
		<table align="center" width="500" border="1" cellspacing="0"
			...
			<tr>
				...
				<td width="378" align="left" valign="middle"><input type="text"
					name="rpno" id="rpno" value="${rpRecords.rpno }"
					readonly="readonly"></td>
			</tr>
			<tr>
				<td width="116" height="30" align="right" valign="middle">工号:</td>
				<td width="378" align="left" valign="middle"><input type="text"
					name="wno" id="wno" value="${rpRecords.wno }"></td>
			</tr>
			<tr>
				<td width="116" height="30" align="right" valign="middle">姓名:</td>
				<td width="378" align="left" valign="middle"><input type="text"
					name="wname" id="wname" value="${rpRecords.wname }"></td>
			</tr>

			<tr>
				<td width="116" height="30" align="right" valign="middle">职位:</td>
				<td width="378" align="left" valign="middle"><input type="text"
					name="wjob" id="wjob" value="${rpRecords.wjob }"></td>
			</tr>
			<tr>
				<td width="116" height="30" align="right" valign="middle">奖励或惩罚:</td>
				<td width="378" align="left" valign="middle"><input type="text"
					name="rewardOrpunish" id="rewardOrpunish"
					value="${rpRecords.rewardOrpunish }"></td>
			</tr>
			<tr>
